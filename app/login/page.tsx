...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-black via-gray-900 to-gray-800 p-4">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-gray-900/80 p-6 shadow-2xl shadow-indigo-500/20 sm:p-8">
        ...
        <a
          href="#"
          className="block text-center text-sm font-semibold text-gray-400 transition-colors duration-300 hover:text-indigo-300 sm:text-base"
        >
          PASSWORT VERGESSEN?
        </a>
